...
```bash
cd /tmp/testdir/
git clone https://github.com/Sh-kawai/simplechat.git
cd simplechat
...
FastAPI実行用のノートブック(https://colab.research.google.com/github/Sh-kawai/lecture-ai-engineering/blob/master/day1/day1_practice.ipynb#scrollTo=meQ4SwISn3IQ)
